	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			*/
			...
			// CHECKBOX
			array(
				'name' => __( 'Hide content', 'meta-box' ),
				'id'   => "{$prefix}hidecontent",
				'type' => 'checkbox',
				'desc'   => __( 'Check this if you want to show only map image', 'meta-box' ),
				// Value can be 0 or 1
				'std'  => 0,
			),
			...
			array(
				'name' => __( 'Align left', 'meta-box' ),
				'id'   => "{$prefix}right",
				'type' => 'checkbox',
				'desc'   => __( 'Default is right', 'meta-box' ),
				// Value can be 0 or 1
				'std'  => 0,
			),
			...
			array(
				// Field name - Will be used as label
				'name'  => __( 'Exchanges filled to date', 'meta-box' ),
				'id'    => "{$prefix}exchanges",
				'desc'  => __( 'Separate numbers with space. Example: 0 1 2 6 3 0', 'meta-box' ),
				'type'  => 'text',
				'std'   => '',
				'clone' => false,
			),
