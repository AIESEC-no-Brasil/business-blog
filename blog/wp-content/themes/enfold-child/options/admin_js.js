...
(function($){
	...
	// Disable price and quantity fioelds if we use MoySklad
	if( $('#re_uuid').val() != '' ) $('#re_price, #re_quantity, #re_byweight, #re_synctime').addClass('disabled').attr('readonly','readonly');
