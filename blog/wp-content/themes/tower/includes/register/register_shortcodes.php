...
if(!function_exists('codeless_sc_contact_info')){
    ...
    function codeless_sc_contact_info($atts, $content = null, $shortcodename=""){
        ...
        extract(shortcode_atts(array("tel" => "", 'addr' => '', 'email' => '', 'hours' => '', 'bbm' => '', 'light' => ''), $atts));
        ...
        $output = '<div class="contact_information '.$light_class.'">';
            ...
            if(!empty($email)):
             ...
             if(!empty($hours)):
                $output .= '<dl class="item dl-horizontal">';
                    $output .= '<dt><i class="moon-clock"></i></dt>';
                    $output .= '<dd><span class="title">'.__('Working Hours', 'codeless').'</span><p>'.$hours.'</p></dd>';
                $output .= '</dl>';
            endif;
